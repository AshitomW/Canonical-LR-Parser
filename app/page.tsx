...
export default function Home() {
  ...
  const [highlightedProduction, setHighlightedProduction] = useState<number | undefined>();
  const [highlightedState, setHighlightedState] = useState<number | undefined>();
  const [highlightedCell, setHighlightedCell] = useState<{ state: number; symbol: string } | undefined>();
    ...
    <div className="app-container">
      ...
      <footer className="app-footer">
        <div className="footer-info">
          <p>Grammar: S' → S | S → L = R | S → R | L → * R | L → id | R → L</p>
          <p>States: {states.length} | Test String: {inputString}</p>
        </div>
      </footer>
    </div>
  );
